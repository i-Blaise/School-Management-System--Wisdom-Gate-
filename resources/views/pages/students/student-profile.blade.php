                        ...
                        <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-top">
                                    <h3 class="font-16">Parents Contact Information</h3>
                                    <div class="">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-7 col-sm-12 col-12">
                            ...
                            <div class="influence-profile-content pills-regular">
                                <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-campaign-tab" data-toggle="pill" href="#pills-campaign" role="tab" aria-controls="pills-campaign" aria-selected="true">Student Detail</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-packages-tab" data-toggle="pill" href="#pills-packages" role="tab" aria-controls="pills-packages" aria-selected="false">Parent Details</a>
                                    </li>
                                    {{-- <li class="nav-item">
